...
class Kumiko:
    ...
    def get_contours(self,gray,array,bgcol):
    ...
    def parse_image(self,array ,url=None):
        ...
        for bgcol in ['white','black']:
            res = self.parse_image_with_bgcol(infos.copy(),array,bgcol,url)
            if len(res['panels']) > 1:
                return res
    ...
    def parse_image_with_bgcol(self,infos,array,bgcol,url=None):

        contours = self.get_contours(self.gray,array,bgcol)
